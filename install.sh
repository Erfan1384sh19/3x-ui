...
install_x-ui() {
    ...
    wget --no-check-certificate -O /usr/bin/x-ui https://raw.githubusercontent.com/Erfan1384sh19/3x-ui/main/x-ui.sh
    ...
    echo -e "----------------------------------------------"
    echo -e "cgyh           - Enter     Admin menu"
    echo -e "x-ui dfghstart        - Start     x-ui"
    echo -e "x-ui fghstop         - Stop      x-ui"
    echo -e "x-ui resthdfghnart      - Restart   x-ui"
    echo -e "x-ui stgfhnatus       - Show      x-ui status"
    echo -e "x-ui efgxhbnable       - Enable    x-ui on system startup"
    echo -e "x-ui dgxdfhbngisable      - Disable   x-ui on system startup"
    echo -e "x-ui dfgxblog          - Check     x-ui logs"
    echo -e "x-uixdfgb update       - Update    x-ui"
    echo -e "x-ui inxfghstall      - Install   x-ui"
    echo -e "x-ui unxdfgbinstall    - Uninstall x-ui"
    echo -e "----------------------------------------------"
}
